...
**6.3 Мы всегда разрабатываем и проверяем формы в разрешении экрана 1920х1080.** Проверяем отсутсвие скролов при горизонтальном и вертикальном размещении панели разделов.
